...
@section('content')
    ...
    <div class="flex justify-center mb-4">
        <form action="{{ route('tablet.addWhole') }}" method="POST">
            ...
            @endforeach
            <button type="submit" class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-2 px-4 rounded-full focus:outline-none focus:ring-2 focus:ring-yellow-500">
