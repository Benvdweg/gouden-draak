            ...
            <div class="w-full max-w-xs">
                <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{ route('tablet.number.set') }}" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="tablenumber" name="tablenumber" type="text" value="{{ old('table_number') }}">
                        @error('table_number')
