        ...
        <div class="container mx-auto p-4">
            <div class="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                @foreach ($orders as $order)
                    ...
                    <a href="{{ route('order.show', ['round_number' => $order->order_lines()->first()->round_number]) }}"
                       class="block border rounded-lg p-4 shadow-md hover:bg-gray-100 transition-colors duration-300">
