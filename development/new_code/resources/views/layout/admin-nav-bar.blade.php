<div class="flex flex-col min-h-screen w-64 px-4 py-8 bg-gray-800 text-gray-100">
    ...
    <div class="mt-auto">
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="w-full text-gray-800 px-4 py-2 text-left bg-red-100 rounded-md hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50">
                Uitloggen
            </button>
        </form>
    </div>
