    ...
    <table id="main_table" style="padding:5px;width:100%;border-collapse: collapse">
        <tr style="height:50px;background-color:red">
            <td style="text-align:center;width:30%;color:yellow;font-size:30px">
                ...
                <img style="vertical-align: middle;" src="pictures/dragon-small-flipped.png" alt="Golden Dragon"
                     height="50px">
            </td>
            <td>
            ...
            <td style="text-align:center">
                ...
                <table width=100%>
                    <tr>
                        <td colspan='3'>
                            <p>
                                <img src="pictures/dragon-small.png" style="float:left;height:200px"
                                     alt="Golden Dragon">
                    ...
                    <tr style="padding-top:50px">
                        ...
                        <td align="center" style='font-size:5px; border:1px solid black;background:floralwhite'><br>
